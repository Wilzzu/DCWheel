const BotInviteButton = () => {
	return (
		<div className="flex flex-col gap-1 items-center justify-center mt-2 pt-2 border-t-2 border-highlightBlack text-xs 2k:text-sm">
			<a
...
export default BotInviteButton;
