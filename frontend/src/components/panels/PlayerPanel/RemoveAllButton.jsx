	...
	return (
		<div className="absolute right-0 flex justify-center">
			<button
				...
				className="relative group flex justify-center items-center w-10 h-10 border-2 rounded-lg bg-darkBlack border-darkBlack hover:bg-highlightBlack hover:border-red-600 disabled:hover:bg-darkBlack disabled:hover:border-darkBlack disabled:opacity-50 duration-300 z-10 drop-shadow-button">
